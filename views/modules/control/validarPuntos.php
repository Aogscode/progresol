...
<div class="container-fluid">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Validar Puntos</li>
  </ol>
  <!-- Breadcrumbs-->
          ...
          <form id="reporteMaestros" method="post">
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                <label for="validaDesde">Desde</label>
                <input type="date" min="2018-01-01" max=<?php echo "'".date('Y-m-d')."'"; ?> id="validaDesde" name="validaDesde" class="form-control">
              </div>
              <div class="form-group col-md-6">
                <label for="validaHasta">Hasta</label>
                <input type="date" min="2018-01-01" max=<?php echo "'".date('Y-m-d')."'"; ?> id="validaHasta" name="validaHasta" class="form-control">
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-6">
            ...
            <div class="col-md-3">
              <button type="button" name="btn_validaPuntos"  id="btn_validaPuntos" class="btn btn-primary btn-lg btn-block">Buscar</button>
            </div>
          </form>
  ...
  <div class="row" style="display:none" id="contenedor_table_valida">
    <div class="col-lg-12">
      <table id="validador_puntos" class="table table-bordered display responsive nowrap" cellspacing="0" > 
